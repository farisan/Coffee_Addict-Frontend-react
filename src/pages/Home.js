                ...
                <main>
                    ...
                    <div className="container">
                        <nav className="nav d-flex justify-content-between align-items-center mx-auto px-4">
                            {/* <div className={`${styles["left-nav"]} d-flex align-items-center py-2`}>
                                <img src={icon_coffee} alt="" className="me-2" widht="27px" height="27px" />
                                <span className="">Coffee Addict</span>
                            </div> */}
                            <div className={`${styles["left-nav"]} d-flex py-4`}>
                                <img src={icon_coffee} alt="" className="me-2" widht="27px" height="27px" />
                                <span className="mt-1">Coffee Addict</span>
                            </div>
                            {/* <div className={`${styles["center-nav"]} d-flex align-items-center`}>
                                <a className="nav-link " href="/index.html">Home</a>
                                <Link to="/product" className="nav-link ">Product</Link>
                                <a className="nav-link " href="#">your Cart</a>
                            ...
                            {/* <div className={`${styles["right-nav"]} d-flex align-items-center`}>
                                <a href="/Login.html" className={styles["login-nav"]}><span>Login</span></a>
                                <a href="/Sign-up.html" className={styles["sign-up-nav"]}><span>Sign Up</span></a>
                            </div> */}
